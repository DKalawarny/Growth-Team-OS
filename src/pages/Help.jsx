...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Tools (GBP Audit, Cash Flow, Hiring Scorecards, etc.) each make an AI call that costs real money to run. The cap keeps your subscription priced at $97 even when you\'re using it heavily. Most owners use 3–5 runs a month total. If you need more, email me — caps are easy to raise.',
  },
  {
