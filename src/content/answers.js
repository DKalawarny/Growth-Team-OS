...
export const ANSWERS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can Eliv8 OS replace one?', a: 'No, and it does not try to. It reads your books and argues decisions with you continuously, which covers the day-to-day thinking. It cannot sit in a funding negotiation or sign off on a transaction, and you should not want software to.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Is it better to have both?', a: 'For many owners, yes — they do different jobs. The software handles the continuous thinking; a person handles the things that need a person.' },
