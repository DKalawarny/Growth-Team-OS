...
const row2 = ['Map.dc.html','Paywall.dc.html']
const row3 = ['Diagnostic.dc.html','Result.dc.html']
const h = f => f === 'S3.dc.html' ? 1500 : f === 'S5.dc.html' ? 1180 : f === 'Map.dc.html' ? 1560 : 844
...
writeFileSync('canvas.json', JSON.stringify({
  artboards: [
    ...
    ...row3.map((f,i) => ({ file: f, x: (i+2)*(W+GAP), y: 1700, w: W, h: h(f) })),
  ],
  annotations: [
    ...
    { id: 'deliver', x: 0, y: 1550, w: 520, text: 'THE MAP is what they paid for. The gate between two moves is the sentence no course gives them.' },
